...
This package requires the python modules 'numpy', 'GPy', 'sklearn', and 'warnings' in the python virtual environment. These modules can be installed onto the current python virtual environment with:
